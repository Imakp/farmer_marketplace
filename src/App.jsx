      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2 cursor-pointer" onClick={() => setCurrentPage('marketplace')}>
            ...
            <span className="text-white font-bold text-xl">Farmers' Marketplace</span>
          </div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-green-100 p-4 rounded-md mb-4 text-center">
        <h2 className="text-lg font-semibold">Welcome to Farmers' Marketplace 🌾</h2>
      ...
      <div className="flex justify-between space-x-6">
        ...
        <div className="flex-1 bg-gray-100 p-6 rounded-md shadow-md">
          ...
          <p className="text-gray-700 mb-4">
            Farmers' Marketplace is dedicated to bridging the gap between farmers and consumers by providing a platform for direct sales, efficient product uploads, and secure payments. We aim to support farmers by helping them reach a wider audience and maximizing their profits.
          </p>
    ...
    <div className="max-w-4xl mx-auto p-6">
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Add your vegetables and fruits to the marketplace</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex space-x-4">
            <Input
